...
public class Subtraction extends javax.swing.JFrame {
    ...
    public void check(){
        ...
        dif = (Integer.parseInt(num1.getText()) - Integer.parseInt(num2.getText()));
        ans = Integer.parseInt(answer.getText());
        
        if(ans != dif){
            JOptionPane.showMessageDialog(null,"Wrong Answer, The Correct Answer is " + dif);
    ...
    private void initComponents() {
        ...
        TXToperation.setText("SUBTRACTION");
