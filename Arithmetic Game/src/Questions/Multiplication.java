...
public class Multiplication extends javax.swing.JFrame {
    ...
    private int scoreCount = 0, i = 61, maxBound;
    ...
    public void generateNum(){
        ...
        num1.setText(String.valueOf(rand.nextInt(maxBound)));
        num2.setText(String.valueOf(rand.nextInt(maxBound)));
    }
    ...
    public void check(){
        ...
        product = (Integer.parseInt(num1.getText()) * Integer.parseInt(num2.getText()));
        ans = Integer.parseInt(answer.getText());
        
        if(ans != product){
            JOptionPane.showMessageDialog(null,"Wrong Answer, The Correct Answer is " + product);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(opration, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(56, 56, 56)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(num1)
